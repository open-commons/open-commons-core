...
public class AbstractOracleInsertDao extends AbstractInsertDao {
    ...
    /**
     * @see open.commons.database.AbstractInsertDao#createInsertAllQuery(java.lang.String, java.lang.String, int)
     */
    @Override
    ...
    /**
     * @see open.commons.database.AbstractInsertDao#getMaxCountPerInsert()
     */
    @Override
    ...
    /**
     * @see open.commons.database.AbstractDao#getQuery(java.lang.String)
     */
    @Override
