...
/**
 * 
 * Throw this when the value of {@link GenericTypeVariable#getTypeVarName()} is
 * not equal to what you expect.
 * 
 * @since 2014. 3. 12.
...
public class IllegalGenericNameException extends RuntimeException {
     ...
     * @since 1.7
     */
    protected IllegalGenericNameException(String message, Throwable cause, boolean enableSuppression,
