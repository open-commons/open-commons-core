...
public class AbstractValidator<D, T> implements IValidator<D, T> {
    ...
    public AbstractValidator(ITokenizer<D, T> tokenizer) {
        ...
        ITokenValidator<T> tokenValidator = new FalseTokenValidator<T>("Unknown Tokens") {
            /**
             * @see open.commons.core.validation.NamedTokenValidator#isPositive()
             */
            @Override
    ...
    /**
     * 
     * @see open.commons.core.validation.IValidator#validate()
     */
    @Override
    ...
    /**
     * 
     * @see open.commons.core.validation.IValidator#validate(boolean)
     */
    @Override
