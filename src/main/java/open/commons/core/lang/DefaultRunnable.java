 ...
 *      날짜      | 작성자   |   내용
 * ------------------------------------------
 * 2013. 6. 20.         parkjunhong77@gmail.com     최초 작성
...
public abstract class DefaultRunnable extends AbstractRunnable implements AutoCloseable {
     ...
     *      날짜    	| 작성자	|	내용
     * ------------------------------------------
     * xxxx.xx.xx.      parkjunhong77@gmail.com     최초 작성
     * 2022. 9. 1.		parkjunhong77@gmail.com     final 제거. 아래 내용을지 원하기 위함.
    ...
    public void run() {
        ...
        // begin - PATCH [2019. 10. 17.]: Process ID를 ThreadContext에 'pid' 라는
        // 이름으로 설정<br>
