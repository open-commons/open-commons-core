...
public class ConcurrentUtils {
     ...
     * 다수의 스레드가 동시에 {@code bucket} 객체의 상태를 변경하므로, 전달되는 {@code bucket}은 반드시 <b>스레드 안전(Thread-Safe)한
     * 객체</b>여야 합니다. (예: {@link java.util.concurrent.ConcurrentHashMap}, 락이 구현된 객체 등)
     * </p>
     *
     * <pre>
     * [개정이력]
