...
public class LoggerFactory {
     ...
     * @see AbstractLogger#dateFormat
     */
    public static ILogger getInstance(String logUrl, String logName, open.commons.core.log.FileLogger.LogFileDivideRule logFileDiviedRule) {
        int hashcode = (logUrl + File.separator + logName).hashCode();
    ...
    static class ConsoleLogger extends AbstractLogger {
        ...
        /**
         * 
         * @see open.commons.core.log.AbstractLogger#afterWrite(PrintStream)
         */
        @Override
        ...
        /**
         * 
         * @see open.commons.core.log.AbstractLogger#getCustomErrLog(java.lang.String, java.lang.Exception, int)
         */
        @Override
        ...
        /**
         * 
         * @see open.commons.core.log.AbstractLogger#getCustomErrLog(java.lang.String, int)
         */
        @Override
        ...
        /**
         * 
         * @see open.commons.core.log.AbstractLogger#getCustomStdLog(java.lang.String, int)
         */
        @Override
        ...
        /**
         * 
         * @see open.commons.core.log.AbstractLogger#getErrOutStream()
         */
        ...
        /**
         * 
         * @see open.commons.core.log.AbstractLogger#getStdOutStream()
         */
        @Override
        ...
        /**
         * 
         * @see open.commons.core.log.AbstractLogger#setErrOutStream(PrintStream)
         */
        @Override
        ...
        /**
         * 
         * @see open.commons.core.log.AbstractLogger#setStdOutStream(PrintStream)
         */
        @Override
