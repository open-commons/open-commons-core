...
public abstract class DefaultTableEntity implements ITableEntity {
    ...
    /**
     * 
     * @see open.commons.core.database.ITableEntity#count()
     */
    @Override
    ...
    /**
     * 
     * @see open.commons.core.database.ITableEntity#createInsertQuery()
     */
    @Override
    ...
    /**
     * 
     * @see open.commons.core.database.ITableEntity#createInsertQuery(java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see open.commons.core.database.ITableEntity#createSelectQuery(int[])
     */
    @Override
    ...
    /**
     * 
     * @see open.commons.core.database.ITableEntity#createSelectQuery(java.lang.String, java.util.Collection, int[])
     */
    @Override
    ...
    /**
     * 
     * @see open.commons.core.database.ITableEntity#createSelectQuery(java.lang.String, int[])
     */
    @Override
    ...
    /**
     * 
     * @see open.commons.core.database.ITableEntity#createUpdateQuery(java.util.Collection, int[])
     */
    @Override
    ...
    /**
     * 
     * @see open.commons.core.database.ITableEntity#createUpdateQuery(int[])
     */
    @Override
    ...
    /**
     * 
     * @see open.commons.core.database.ITableEntity#createUpdateQuery(java.lang.String, java.util.Collection, int[])
     */
    @Override
    ...
    /**
     * 
     * @see open.commons.core.database.ITableEntity#createUpdateQuery(java.lang.String, int[])
     */
    @Override
