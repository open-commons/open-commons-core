...
public enum DnsRecordType {
     ...
     * 설명: Specifies authoritative information about a DNS zone, including the primary name server,
     * the email of the domain administrator, the domain serial number, and several timers relating
     * to refreshing the zone.<br>
     */
    SOA("SOA", 6,
